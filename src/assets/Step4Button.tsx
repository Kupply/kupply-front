...
const ButtonWrapper = styled.button<Step4ButtonProps>`
  ...
  box-shadow: ${(props) =>
    props.state === "default"
      ? "0px 0px 12px 0px  rgba(216, 88, 136, 0.10)"
      : "none"};
  border: ${(props) =>
    props.state === "default"
      ? "none"
  ...
  return (
    <ButtonWrapper state={state} {...rest}>
      ...
      {(state === "default" || state === "clicked") && !double ? (
        <img
          src="../../design_image/step4_button/chick.png"
          width="90px"
          height="90px"
        />
      ) : (state === "default" || state === "clicked") && double ? (
        <img
          src="../../design_image/step4_button/chick_hood.png"
          width="90px"
          height="90px"
        />
      ) : state === "unactive" && !double ? (
        <img
          src="../../design_image/step4_button/chick_2.png"
          width="90px"
          height="90px"
        />
      ) : (
        <img
          src="../../design_image/step4_button/chick_hood_2.png"
          width="90px"
          height="90px"
        />
      )}
