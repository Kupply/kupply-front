...
const IconWrapper = styled.div<AlertIconExclamationProps>`
  position: relative;
...
export interface AlertIconExclamationProps
  extends React.ComponentPropsWithoutRef<"div"> {
  width: string;
  height: string;
}

export default function AlertIconExclamation({
  width,
  height,
}: AlertIconExclamationProps) {
  return (
