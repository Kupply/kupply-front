...
function DropDown({ title, optionList, value, setValue, width, height }: DropDownProps) {
...
const InputWrapper = styled.input<{ isOpen: boolean; isSelected: boolean; width?: string; height?: string }>`
  width: ${(props) => props.width || '628px'}; // Set width using the prop or a default value
  height: ${(props) => props.height || '68px'}; // Set height using the prop or a default value
  border-radius: 10px;
