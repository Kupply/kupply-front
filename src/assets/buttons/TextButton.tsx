...
const TextButton01 = (props: ButtonProps) => {
  const { children, fontSize='0.833vw', fontWeight='500', ...rest} = props;
...
const TextButton02 = (props:ButtonProps) => {
  ...
  return <Container02 onMouseOver={handleHover} onMouseLeave={handleHoverOut} {...rest}>
    <div style={{marginRight: '0.21vw'}}>
      {buttonState === 'default' ? 
      <svg xmlns="http://www.w3.org/2000/svg" width={`${fontSize}`} height={`${fontSize}`} viewBox="0 0 20 20" fill="none">
    ...
    <Typography02 state={buttonState} style={{fontSize: `${fontSize}`, fontWeight: `${fontWeight}`}}>{children}</Typography02>
  </Container02>
}
...
const TextButton03LNB = (props:ButtonProps) => {
  ...
  return <Container03LNB onMouseOver={handleHover} onMouseLeave={handleHoverOut} {...rest}>
    <Typography03LNB state={buttonState} style={{fontSize: `${fontSize}`, fontWeight: `${fontWeight}`}}>{children}</Typography03LNB>
  </Container03LNB>
};
...
const TextButton03Settings = (props:TextButtonProps) => {
  ...
  return <Container03Settings onClick={handleClick} {...rest}>
    <Typography03Settings state={selected === true ? 'pressed' : 'default'} style={{fontSize: `${fontSize}`, fontWeight: `${fontWeight}`}}>{children}</Typography03Settings>
  </Container03Settings>
}
...
const TextButton05 = (props:TextButtonProps05) => {
  ...
  return <Container05 onMouseEnter={handleHover} onMouseLeave={handleHoverOut} onClick={handleClick} {...rest}>
    <Typography05 state={buttonState} style={{fontSize: `${fontSize}`}}>{children}</Typography05>
  </Container05>
}
...
const TextButton06 = (props: TextButtonProps06) => {
  ...
  return (
    ...
    <Container06 onClick={handleClick} onMouseEnter={handleHover} onMouseLeave={handleHoverOut} {...rest}>
      {buttonState === 'default' ? 
      <svg xmlns="http://www.w3.org/2000/svg" width={`${fontSize}`} height={`${fontSize}`} viewBox="0 0 18 18" fill="none">
  ...
  <path d="M15 15.75V14C15 13.0717 14.6839 12.1815 14.1213 11.5251C13.5587 10.8687 12.7956 10.5 12 10.5H6C5.20435 10.5 4.44129 10.8687 3.87868 11.5251C3.31607 12.1815 3 13.0717 3 14V15.75" fill="#D85888" stroke="#D85888" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <Typography06 state={buttonState} style={{fontSize: `${fontSize}`, fontWeight: `${fontWeight}`}}>{nickName}</Typography06>
