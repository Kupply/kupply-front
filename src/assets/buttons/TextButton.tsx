...
const TextButton01 = (props: ButtonProps) => {
  ...
  return (
    <Container01 onMouseOver={handleHover} onMouseLeave={handleHoverOut} {...rest}>
      <div
        style={{
          transform: 'revert(90)',
          flexShrink: '0',
      ...
      <Typography01 state={buttonState} style={{ fontSize: `${fontSize}`, fontWeight: `${fontWeight}` }}>
        {children}
      </Typography01>
    </Container01>
  );
...
const TextButton04 = (props: TextButtonProps) => {
  ...
  return (
    <Container04 onClick={handleClick} {...rest}>
      <Typography04 state={selected === false ? 'pressed' : 'default'} style={{ fontSize: `${fontSize}` }}>
        {children}
      </Typography04>
    </Container04>
  );
