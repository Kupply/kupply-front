...
function MobileHeader({ logined, setLogin }: HeaderProps) {
  ...
  const handleKoreapasClick = () => {
      ...
      window.open(
        "https://www.koreapas.com/m/mlist.php?id=club",
        "_blank",
        "noopener,noreferrer"
      );
  };
              ...
              {isToggleOpen && (
                <ToggleMenu>
                  ...
                  <BodyBox>
                    ...
                    <MenuOption onClick={handleKoreapasClick} style={{ marginTop: '3.06vw'}}>
                      <MenuText1 color="#E283A7">고파스 이중전공 게시판</MenuText1>
                    </MenuOption>
                    <Vector />
...
const Container = styled.div`
  ...
  box-shadow: 0 2.79vw 6.98vw 0 rgba(223, 223, 223, 0.40);
  backdrop-filter: blur(1.26vw);
`;
...
const MenuText1 = styled.text<{ color?: string }>`
