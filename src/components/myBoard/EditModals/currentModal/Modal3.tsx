...
import { SemesterVerification } from "../../../signUp/VerificationForm";
import MoveButton from "../MoveButton";
import { EditCurrentModalProps } from "./Modal0";

export default function CurrentModal3(props:EditCurrentModalProps){
    ...
    <ContentsWrapper2>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5vw' }}>
        <SubContentsWrapper>
          ...
          <SemesterVerification userType="candidate" locationUsed="Settings"/>
        </SubContentsWrapper>
      </div>
      <MoveButton
