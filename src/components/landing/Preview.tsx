        ...
        <CardList style={{ gap: '57px', marginTop: '324.5px' }}>
          <Card>
            ...
            <img
              width="392px"
              height="245px"
              src="../../designImage/landing/Preview1.png"
          ...
          <Card>
            ...
            <img
              width="284px"
              height="284px"
              src="../../designImage/landing/Preview2.png"
              style={{ position: 'absolute', bottom: 0, right: 0 }}
            />
          </Card>
        </CardList>
        <CardList style={{ gap: '42px', marginTop: '189.5px' }}>
          <Card>
            ...
            <img
              width="254px"
              height="254px"
              src="../../designImage/landing/Preview3.png"
              style={{ position: 'absolute', bottom: 0, right: 0 }}
            />
          </Card>
          <Card>
            ...
            <img
              width="338px"
              height="267px"
              src="../../designImage/landing/Preview4.png"
              style={{ position: 'absolute', bottom: 0, right: 0 }}
            />
          </Card>
          <Card>
            ...
            <img
              width="320px"
              height="256px"
              src="../../designImage/landing/Preview5.png"
              style={{ position: 'absolute', bottom: 0, right: 0 }}
            />
          </Card>
        </CardList>
        <CardList style={{ gap: '57px', marginTop: '324.5px' }}>
          <Card>
            ...
            <img
              width="289x"
              height="289px"
              src="../../designImage/landing/Preview6.png"
              style={{ position: 'absolute', bottom: 0, right: 0 }}
            />
          </Card>
          <Card>
            ...
            <img
              width="289px"
              height="236px"
              src="../../designImage/landing/Preview7.png"
              style={{ position: 'absolute', bottom: 0, right: 0 }}
            />
          </Card>
        </CardList>
