        ...
        {college == 0 && page == 0 ? (
          <>
            ...
            <Button08
              ...
              answer={[
                [{ text: '이중전공은 서울 캠퍼스 소속 학과 범위에서 최대 2지망까지 지원할 수 있습니다.', bold: '500' }],
                [
                  {
            ...
            <Button08
              ...
              answer={[
                ...
                [{ text: '*세부 전형방법 및 제출서류는 포털 공지사항을 확인하여주시기 바랍니다.', bold: '500' }],
              ]}
            />
            <Button08
              key="common4"
          ...
          <>
            ...
            <Button08
              ...
              answer={[[{ text: '불가합니다. 금학기 휴학생 신분이신 경우 이중전공 지원이 불가합니다.', bold: '500' }]]}
            />
            <Button08
              key="common7"
          ...
          <>
            <Button08
              ...
              answer={[
                [
                  { text: '이번 학기에도', bold: '500' },
                  { text: ' 면접 전형 없이,', bold: '700' },
                  { text: ' 성적 및 학업계획서만을 바탕으로 심사가 진행됩니다.', bold: '500' },
                ],
              ]}
            />
            <Button08
