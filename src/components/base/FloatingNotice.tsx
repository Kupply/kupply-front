    ...
    <>
      ...
      >
        ...
        <Description>
          ...
          <Paragraph>
            쿠플라이는 고려대학교 이중전공 지원 정보를 더 편리하게 확인할 수 있도록 교내 SW 개발 동아리 DevKor 소속
            개발자 5명과 디자이너 3명이 함께 만들고 운영해 온 서비스입니다. 그동안 많은 학우분께서 서비스를 이용해
            주시고 응원해 주신 덕분에 지금까지 운영을 이어올 수 있었습니다.
          </Paragraph>
          <Paragraph>
            다만 운영진 대부분이 졸업 이후 취업 등으로 각자의 업무를 이어가게 되면서, 기존 개발팀이 지속적인 유지보수와
            데이터 관리를 안정적으로 수행하기 어려운 상황이 되었습니다. 이에 서비스를 종료하는 대신, 쿠플라이가
            안정적으로 계속 운영될 수 있도록 운영 주체를 고파스로 이전하기로 했습니다.
          </Paragraph>
          <Paragraph>
            쿠플라이는 기존에도 고파스 계정을 기반으로 로그인해 왔기 때문에 별도의 재가입은 필요하지 않습니다. 운영
            주체가 변경된 이후에도 주요 기능과 이용 방식은 현재와 동일하게 유지될 예정입니다.
          </Paragraph>
          <Paragraph>
            운영 이전 이후 서비스 이용 및 개인정보 관련 문의는 고파스 측 문의 채널을 통해 부탁드립니다.
          </Paragraph>
          <Paragraph>짧지 않은 시간 동안 쿠플라이를 믿고 함께해 주신 모든 분께 진심으로 감사드립니다.</Paragraph>
        </Description>
      </Wrapper>
    </>
  );
