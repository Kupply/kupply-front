    ...
    <>
      <Wrapper>
        <LeftSideWrapper>
          <MyInformationBox>
            ...
            <div style={{ marginTop: '44px', display: 'flex', alignItems: 'center' }}>
              ...
              <InterestMajorEditButton style={{ marginLeft: 'auto' }}>관심 전공 수정</InterestMajorEditButton>
            </div>
            ...
            <div style={{ display: 'flex', marginTop: '26px' }}>
              <InterestMajorBox>
                ...
                <div style={{ marginTop: '16px', marginLeft: '130px' }}>
                  ...
                  <Typography
                    size="smallText"
                    style={{ color: 'var(--Main-Black, #141414)', lineHeight: '114.286%', opacity: 0.8 }}
                  >
                    School of Media
                    <br />& Communication
                  </Typography>
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <InterestMajorButton style={{ marginTop: '154px', marginLeft: '18px' }}>1지망</InterestMajorButton>
          <InterestCommunitySearchBox style={{ marginTop: '154px', marginLeft: '581px' }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M2.80078 8.1998C2.80078 5.21747 5.21844 2.7998 8.20078 2.7998C11.1831 2.7998 13.6008 5.21747 13.6008 8.1998C13.6008 9.64962 13.0294 10.966 12.0996 11.936C12.0699 11.9596 12.0412 11.9852 12.0137 12.0127C11.9862 12.0402 11.9606 12.0689 11.937 12.0986C10.967 13.0284 9.6506 13.5998 8.20078 13.5998C5.21844 13.5998 2.80078 11.1821 2.80078 8.1998ZM12.6786 14.0918C11.4354 15.038 9.88368 15.5998 8.20078 15.5998C4.11387 15.5998 0.800781 12.2867 0.800781 8.1998C0.800781 4.1129 4.11387 0.799805 8.20078 0.799805C12.2877 0.799805 15.6008 4.1129 15.6008 8.1998C15.6008 9.8827 15.039 11.4344 14.0928 12.6776L16.9079 15.4927C17.2984 15.8832 17.2984 16.5164 16.9079 16.9069C16.5174 17.2974 15.8842 17.2974 15.4937 16.9069L12.6786 14.0918Z"
                fill="#A8A8A8"
              />
            </svg>
        ...
        <div style={{ marginLeft: '551px' }}>
          <BigMajorSymbolBox style={{ marginTop: '32px' }}>
            ...
            <Typography
              size="largeText"
              style={{
                color: 'color: var(--Main-Black, #141414)',
                fontWeight: '500',
                opacity: '0.8',
                marginTop: '0px',
                textAlign: 'center',
...
const InterestCommunitySearchBox = styled.div`
  // 그림만 해놓고 기능 구현 나중에.. (크기가 좀 다른것 같기도 하고)
  display: flex;
  width: 394px;
  height: 46px;
  padding: 10px 20px;
