          ...
          <div style={{ marginTop: "-82px" }}> 
            <MyInformationBox translateY={scrollY} >
              ...
              <div style={{ marginTop: '15px' }}>
                <Typography size="bodyText" style={{ color: 'rgba(67, 67, 67, 0.60)', fontWeight: '500', marginLeft: "128.01px" }}>
                  디자인조형학부 20학번
                </Typography>
              </div>
              <svg
                ...
                <InterestMajorBox>
                  <MajorSymbolShadow>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="112" height="112" viewBox="0 0 112 112" fill="none">
                      ...
                      <defs>
                        <radialGradient id="paint0_radial_3725_3779" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(56 58.5751) rotate(90) scale(53.4249)">
                ...
                <InterestMajorBox>
                  <MajorSymbolShadow>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="112" height="112" viewBox="0 0 112 112" fill="none">
                      ...
                      <defs>
                        <radialGradient id="paint0_radial_3725_1679" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(56 58.5751) rotate(90) scale(53.4249)">
...
const BigMajorSymbolBox = styled.div`
  ...
  background: radial-gradient(231.86% 143.11% at 1.23% 100%, rgba(255, 255, 255, 0.90) 0%, rgba(255, 255, 255, 0.00) 100%);
...
const CompetitionRateBox = styled.div`
  ...
  border-radius: 10px;
  border: 1px solid var(--DF_Grey-2, #DFDFDF);
  background: radial-gradient(230.3% 140.56% at 1.23% 100%, rgba(255, 255, 255, 0.90) 0%, rgba(255, 255, 255, 0.00) 100%);
  backdrop-filter: blur(12px);
`;
...
const Graph_2Box = styled.div`
  ...
  height: 828px;
  flex-shrink: 0;
  fill: radial-gradient(230.3% 140.56% at 1.23% 100%, rgba(255, 255, 255, 0.90) 0%, rgba(255, 255, 255, 0.00) 100%);
  stroke-width: 1px;
