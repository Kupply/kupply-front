...
export function SignUp4PageCandidate() {
  ...
  useEffect(() => {
    console.log(hopeMajor1, hopeMajor2, GPA1, GPA2, GPA3, hopeSemester1, hopeSemester2, hopeSemester3);
    if (
      !!hopeMajor1 &&
      !!hopeMajor2 &&
      !!GPA1 &&
      ...
      <FormWrapper>
        ...
        <ContentsList>
          ...
          <ContentsWrapper>
            ...
            <VerifiBoxWrapper>
              <VerificationBox value={GPA1} onValueChange={(value) => setGPA1(value)} />
              <Dot size="mediumText">.</Dot>
              <VerificationBox value={GPA1} onValueChange={(value) => setGPA2(value)} />
              <VerificationBox value={GPA1} onValueChange={(value) => setGPA3(value)} />
            </VerifiBoxWrapper>
          </ContentsWrapper>
          <ContentsWrapper>
            <div style={{ display: "flex" }}>
            ...
            <VerifiBoxWrapper>
              <VerificationBox
                value={hopeSemester1}
                onValueChange={(value) => setHopeSemester1(value)}
              ></VerificationBox>
              <VerificationBox
                value={hopeSemester2}
                onValueChange={(value) => setHopeSemester2(value)}
              ></VerificationBox>
              <Dash size="mediumText">-</Dash>
              <VerificationBox
                value={hopeSemester3}
                onValueChange={(value) => setHopeSemester3(value)}
              ></VerificationBox>
            </VerifiBoxWrapper>
          </ContentsWrapper>
        </ContentsList>
...
export function SignUp4PagePasser() {
  ...
  useEffect(() => {
    console.log(doubleMajor, GPA1, GPA2, GPA3, passSemester1, passSemester2, passSemester3);
        ...
        <ContentsList>
          ...
          <ContentsWrapper>
            ...
            <VerifiBoxWrapper>
              <VerificationBox
                value={passSemester1}
                onValueChange={(value) => setPassSemester1(value)}
              ></VerificationBox>
              <VerificationBox
                value={passSemester2}
                onValueChange={(value) => setPassSemester2(value)}
              ></VerificationBox>
              <Dash size="mediumText">-</Dash>
              <VerificationBox
                value={passSemester3}
                onValueChange={(value) => setPassSemester3(value)}
              ></VerificationBox>
            </VerifiBoxWrapper>
          </ContentsWrapper>
        </ContentsList>
